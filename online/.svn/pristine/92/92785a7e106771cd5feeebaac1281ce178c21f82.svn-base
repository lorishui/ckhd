 ...
 */
package me.ckhd.opengame.common.config;
...
import me.ckhd.opengame.common.utils.PropertiesLoader;
...
public class Global {
	 ...
	 * 属性文件加载对象
	 */
	private static PropertiesLoader loader = new PropertiesLoader("opengame.properties");
	 ...
	 */
	public static String getConfig(String key, boolean isRequire) throws IllegalArgumentException {
	 ...
	 * @return
	 */
	public static Integer getConfig(String key, Integer defVal) {
		String val = Global.getConfig(key);
