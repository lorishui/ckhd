...
<body> 
	<form:form id="searchForm"  modelAttribute="offlineMoneyCount" action="${ctx}/offlineMoneyCount/andGraphical" method="post" class="breadcrumb form-search">
	...
	<div class="graph">
		<div class="position"><font size="3">咪咕金额统计</font></div>
	    <div class="bottom">
