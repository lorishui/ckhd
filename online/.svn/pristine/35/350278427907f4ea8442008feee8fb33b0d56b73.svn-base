...
import me.ckhd.opengame.online.handle.common.alipay.SignUtils;
...
public class alipayHandle extends BaseHandle{
	...
	public String getOrderInfo(OnlinePay onlinePay,String subject, String body, String price) {
		...
		String notifyUrl = StringUtils.isNotBlank(onlinePay.getNotifyUrl())?onlinePay.getNotifyUrl():onlinePay.getPayInfoConfig().getNotifyUrl();
		// 服务器异步通知页面路径
