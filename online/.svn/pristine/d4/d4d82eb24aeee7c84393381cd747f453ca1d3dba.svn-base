package me.ckhd.opengame.online.handle.common.vivo;
...
public class VivoSignUtils {
	static Logger log = LoggerFactory.getLogger(VivoSignUtils.class);
	//vivo分配的商户私钥
	...
	public static String buildReq(Map<String, String> req, String key) {
		...
		return createLinkString(filteredReq, true, true);		//请求字符串，key不需要排序，value需要URL编码
	}
    ...
    public static boolean verifySignature(Map<String, String> para, String key) {
        ...
        log.info("vivo 服务器签名：" + signature + " | 请求消息中的签名：" + respSignature);
        // 对比签名值
	...
	public static String getVivoSign(Map<String,String> para, String key) {
		...
		log.info("vivo sign content="+prestr);
    ...
    public static void main(String[] args) {
    	String prestr = "appId=c3988130b9cb52ce6c3bb2856f4ba71e&cpId=20151113101410601305&cpOrderNumber=291702170001fe23&orderAmount=1&orderNumber=2017021717014767300012911589&payTime=20170217170207&respCode=200&respMsg=交易成功&tradeStatus=0000&tradeType=01&uid=9e9741702e57d9e1&3cec6a257ead55c74f8bbf092bda872c";
    	String key = "540790551f12982488d60ba5cf501b7a";
//    	prestr = prestr + QSTRING_SPLIT + md5Summary(key);
		System.out.println(md5Summary(key));
		System.out.println(md5Summary(prestr));
	}
}
