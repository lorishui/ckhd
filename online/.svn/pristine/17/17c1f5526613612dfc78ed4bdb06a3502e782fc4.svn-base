...
<body> 
	<form:form id="searchForm"  modelAttribute="offlineMoneyCount" action="${ctx}/offlineMoneyCount/graphMoneyByManyDay" method="post" class="breadcrumb form-search">
		...
		<div class="query_column_space">
			...
			<a href="#" onclick="javascript:selectDateFn(2);void(0)">前天</a>s
