...
import me.ckhd.opengame.util.https.ErrorCode;
import me.ckhd.opengame.util.https.MySecureProtocolSocketFactory;
...
public class SnsNetwork{
	private final static Logger log = LoggerFactory.getLogger(SnsNetwork.class);
    ...
    public static String postRequest(String url, Map<String, String> params, 
    		Map<String, String> cookies,String protocol){
        ...
        try{
           ...
           log.error(ErrorCode.NETWORK_ERROR+"Request [" + url + "] failed:" +  e.getMessage(), e);
        }catch (IOException e){
            //发生网络异常
        	 log.error(ErrorCode.NETWORK_ERROR+"Request [" + url + "] failed:" +  e.getMessage(),e);
        }
     ...
     * @throws OpensnsException 网络故障时抛出异常。
     */
    public static String getRequest(String url, HashMap<String, String> cookies,String protocol){
        if (protocol.equalsIgnoreCase("https")){
            Protocol httpsProtocol = new Protocol("https",new MySecureProtocolSocketFactory(), 443);
            Protocol.registerProtocol("https", httpsProtocol);
        }
     ...
     * @throws OpensnsException 网络故障时抛出异常。
     */
    public static String postRequestWithFile(String url,HashMap<String, String> params, 
            HashMap<String, String> cookies,FilePart fp,String protocol){
        if (protocol.equalsIgnoreCase("https")){
            Protocol httpsProtocol = new Protocol("https", new MySecureProtocolSocketFactory(), 443);
            Protocol.registerProtocol("https", httpsProtocol);
        }
