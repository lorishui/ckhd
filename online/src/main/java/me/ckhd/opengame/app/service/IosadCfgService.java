...
@Service("IosadCfgService")
public class IosadCfgService implements CfgService{
	...
	public Map<String, Object> getCfg(Cfgparam cfgparam) {
		...
		String key = "iosad_" + cfgparam.getCkAppId() + "_"
				+ cfgparam.getVersionName();
		Map<String, Object> result = (Map<String, Object>) CacheUtils.get(key);
		if (result == null) {
			Cfgparam vo = cfgparamDao.findIosad(cfgparam);
			if( vo != null){
