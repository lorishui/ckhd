...
import me.ckhd.opengame.sys.security.SystemAuthorizingRealm;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void saveRole(Role role) {
		...
		if (role.getResourceList().size() > 0){
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.ckhd.me\r\n");
		sb.append("\r\n======================================================================\r\n");
