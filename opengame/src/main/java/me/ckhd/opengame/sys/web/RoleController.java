...
public class RoleController extends BaseController {
	...
	public String form(Role role, Model model) {
		List<String> ckAppIdsList = new ArrayList<String>();
		List<String> channelIdsList = new ArrayList<String>();
		...
		if(StringUtils.isNotBlank(role.getCkappIds())){
			ckAppIds =  role.getCkappIds().split(",");
			Collections.addAll(ckAppIdsList, ckAppIds);
		}
		if(StringUtils.isNotBlank(role.getChannelIds())){
			channelIds = role.getChannelIds().split(",");
			Collections.addAll(channelIdsList, channelIds);
		}
		model.addAttribute("ckAppIdsList", ckAppIdsList);
		model.addAttribute("channelIdsList", channelIdsList);
