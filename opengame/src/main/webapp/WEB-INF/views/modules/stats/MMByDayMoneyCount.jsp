...
<body> 
	<form:form id="searchForm"  modelAttribute="offlineMoneyCount" action="${ctx}/offlineMoneyCount/graphMMByDay" method="post" class="breadcrumb form-search">
		...
		<div class="query_column_space">
			...
			<input id="startTime" name="startTime" type="text" readonly="readonly" maxlength="20" class="WdateTime required"
				value="${offlineMoneyCount.startTime}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
		</div>
		<div class="query_column_space">
			<label>时间范围：&nbsp;</label>
	...
	<div class="graph">
	    ...
	    <div class="bottom">
	    	<button value="成功金额" onclick="clickSuccess(this);" class="button${offlineMoneyCount.dataType eq 0 or offlineMoneyCount.dataType eq 1?' check':'' }">
	    		<label>
