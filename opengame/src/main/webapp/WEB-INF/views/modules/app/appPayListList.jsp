...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="appPayList">
			<tr>
				<td>${fns:getByCkAppName(appPayList.ckAppId)}(${appPayList.ckAppId})</td>
				...
				<td>
					...
					<a href="${ctx}/app/appPayList/delete?id=${appPayList.id}" onclick="return confirmx('确认要删除吗？', this.href)">删除</a>
				</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
