...
<head>
	...
	<script type="text/javascript">
		...
		function click(id){
			$("#myFrame").attr("src","${ctx}/app/view?id="+id);
		}
	</script>
	<style type="text/css">
		.channel_break{
			word-break:break-word;min-width:300px
		}
	</style>
</head>
<html>
...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<th>产品</th><th>运营商</th><th>MMAPPID</th><th>渠道</th><th>版本号</th><th>省份</th><th>时间区间</th>
		...
		<c:forEach items="${page.list}" var="appCfgParam">
			<tr>
				<td>${fns:getByCkAppName(appCfgParam.ckAppId)}(${appCfgParam.ckAppId })</td>
				<td>${appCfgParam.carriers}</td>
				<td>${appCfgParam.mmAppId }</td>
				<td class="channel_break">${fns:findChannelName(appCfgParam.ckChannelId,appCfgParam.ckChannelId) eq null?appCfgParam.ckChannelId:fns:findChannelName(appCfgParam.ckChannelId,appCfgParam.ckChannelId)}</td>
	...
	<iframe id="myFrame" marginwidth="0" marginheight="0" frameborder="0" scrolling="no"  width="100%" height="200px" />
</body>
</html>