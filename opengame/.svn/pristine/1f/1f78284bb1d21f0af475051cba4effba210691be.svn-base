...
<body> 
	<form:form id="searchForm"  modelAttribute="offlineMoneyCount" action="${ctx}/offlineMoneyCount/graphMMByManyDay" method="post" class="breadcrumb form-search">
		<input id="dataType" type="hidden" name="dataType" value="${offlineMoneyCount.dataType }" />
		<div id="query_column_space">
			<label>游戏：</label>
