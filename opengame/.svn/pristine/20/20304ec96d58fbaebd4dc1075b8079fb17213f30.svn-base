...
public class SendTextUtil {
	static Logger log = LoggerFactory.getLogger(SendTextUtil.class);
	...
	public static boolean send(String ckAppId,String cellphoneNumber,String code){
		//公共参数
		String Format="JSON";
		...
		String TemplateCode = DictUtils.getDictValue(ckAppId, "sms_code", "SMS_57850040");
