...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			// <c:if test="${tabmode eq '1'}"> 下拉资源以选项卡方式打开
	...
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li id="themeSwitch" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:cookie('tabmode','${tabmode eq '0' ? '1' : '0'}');location=location.href">${tabmode eq '0' ? '开启' : '关闭'}页签模式</a></li>
						</ul>
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getResourceList()}" var="menu" varStatus="idxStatus">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2015-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.ckhd.me" target="_blank">创酷互动</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
