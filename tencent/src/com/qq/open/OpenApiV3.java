...
public class OpenApiV3
{
    ...
    public static void main(String[] args) throws OpensnsException {
    	OpenApiV3 open = new OpenApiV3("1105301798", "Lx9krH6WProMRyLG");
    	open.setServerName("msdktest.qq.com/mpay/buy_goods_m");
    	...
    	System.out.println(open.api("/v3/pay/pay", params, "http"));
	}
}
