 ...
 *
 */
@Service("EgameextendCfgService")
public class EgameextendCfgService implements CfgService {

	public final static String KEY_NAME = "egameextend";
	
	public Logger log = LoggerFactory.getLogger(EgameextendCfgService.class);
	...
	public Map<String, Object> getCfg(Cfgparam cfgparam) {
		...
		if (result == null) {
			Cfgparam vo = cfgparamDao.findEgameextend(cfgparam);
			if( vo != null){
