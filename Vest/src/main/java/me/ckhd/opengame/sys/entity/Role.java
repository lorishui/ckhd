...
//	private String dataScope;// 数据范围
	...
	private String ckappChildIds;	//可访问子游戏
	private String channelIds;  //可访问渠道
	private User user;		// 根据用户ID查询角色列表
	
	private String mediaNames;	//可访问推广媒体
...
//	}
	...
	public String getCkappChildIds() {
		return ckappChildIds;
	}

	public void setCkappChildIds(String ckappChildIds) {
		this.ckappChildIds = ckappChildIds;
	}
