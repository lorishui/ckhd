...
//        String str = "{\"openId\":\"oCGK40wxIgyVc_X5q5QG8ze6IsBg\",\"accessToken\":\"YDSQB4UT7icLzeKUw3B6SSGcAXpwJgTQDIGAT-ln2xz4tukPph0xPJb_LuwB_5dipHIuXVQOoJuNfciP0jOdp3hftULd0Yzjw7r1DDj47Jg\",\"ip\":\"192.168.1.108\",\"tencentLoginType\":2,\"pfKey\":\"d81df1dee0272d7ed8c1f058dafd4a4d\"}";
	    String str = "{\"openId\":\"072235A74EFCF2912E80AE2BAD010628\",\"accessToken\":\"A29C3BC47AC735369145A51783B8762F\",\"ip\":\"192.168.1.101\",\"tencentLoginType\":1,\"ip\":\"192.168.1.108\",\"pfKey\":\"109c9301f40d6afda87d91f74053925e\"}";
...
//        other.pay_m(json, "60", "ya1706260f92c118");
    ...
    private String get_balance_m(JSONObject testData){
        ...
        try {
            ...
            String sigContent = SignContext.getSignContextUrlEncode(param, header, "&");
            logger.info("tencent get_balance_m sigContent="+sigContent);
//            String sig = CoderUtils.makeSig(sigContent,"p8Dy51c6lCTCDcIHpNhV16A9JiKh4uuk&");//极品的
            String sig = CoderUtils.makeSig(sigContent,"pX0cszxmiy8oK0HjBonjHW4D0AaBk3Wy&");//精灵猎人
            param.put("sig", URLEncoder.encode(sig.replace("\r", "").replace("\n", ""),"utf-8").replace("+", "%2B").replace("*", "%2A"));
            logger.info("tencent get_balance_m sig="+param.get("sig"));
    ...
    private Map<String,String> getParam(JSONObject json) throws UnsupportedEncodingException{
        ...
        if( json != null && json.size()>0 ){
            ...
            map.put("openkey" , json.get("accessToken")!=null?json.get("accessToken").toString():"");
//          map.put("pay_token" , data.get("payToken")!=null?data.get("payToken").toString():"");
//            map.put("appid" , "1106091294");
            map.put("appid" , "1106210531");
            map.put("ts" , System.currentTimeMillis()/1000+"");
