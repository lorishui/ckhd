...
<body>
	...
	<form:form id="inputForm" modelAttribute="cfg" action="${ctx }/app/save"  method="post" class="form-horizontal">
		...
		<form:hidden path="childCkAppId"/>
		<input type="hidden" name="type" value="${type }"/>
		<input id="jsonStr" type="hidden" name="jsonStr" value="${cfg.exInfo }"/>
		<div class="control-group">
			<label class="control-label">游戏:</label>
			<div class="controls">
				<input  readonly="readonly" class="required" value="${fns:getByCkAppNameByChild(cfg.ckAppId,cfg.childCkAppId)}(${cfg.ckAppId})"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">子游戏:</label>
			<div class="controls">
				<input  readonly="readonly" class="required" value="(${cfg.childCkAppId})"/>
			</div>
		</div>
		<div class="control-group">
