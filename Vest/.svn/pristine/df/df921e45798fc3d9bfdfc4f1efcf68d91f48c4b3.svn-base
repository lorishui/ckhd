...
<body> 
	<form:form id="searchForm"  modelAttribute="statRelate" action="${ctx}/stats/graphAct" method="post" class="breadcrumb form-search">
	...
	<div class="graph">
		<div class="position"><font size="3">设备活跃统计</font></div>
	     <div class="bottom">
	    	<button value="活跃设备" class="button">
	    		<label>
	    			<font size="1">活跃设备</font><br/>
	    			<font size="5">${statRelate.actNum}</font><br/>
	    		</label>
	    	</button>
	    </div>
