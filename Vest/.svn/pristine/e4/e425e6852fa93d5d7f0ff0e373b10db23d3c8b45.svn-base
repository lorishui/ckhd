...
public abstract class Version {
	 ...
	 * @return
	 */
	public abstract Result<Void> queryOrderState(JSONObject codeJson, HttpServletRequest request);
	...
	public String query(Map<String, String> param, String engName, HttpServletRequest request, HttpServletResponse response){
		return null;
	}
}
